...
/* package todo-app-hs-0.1.0.0 */
#ifndef VERSION_todo_app_hs
#define VERSION_todo_app_hs "0.1.0.0"
#endif /* VERSION_todo_app_hs */
#ifndef MIN_VERSION_todo_app_hs
#define MIN_VERSION_todo_app_hs(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_todo_app_hs */
...
#define CURRENT_COMPONENT_ID "todo-app-hs-0.1.0.0-inplace-todo-app-hs"
